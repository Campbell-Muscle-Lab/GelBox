...
classdef GelBox < matlab.apps.AppBase
    ...
    methods (Access = public)
                ...
                for i=1:n
                    ...
                    switch num_of_bands
                        case 1
                            ...
                            fit_1gaussian(y,x,x_back,num_of_bands);
                        case 2
                            [x_bands,x_fit,r_squared] = ...
                    ...
                    if (i==selected_box)
                       ...
                       plot(app.raw_density,x_back,y,':g',"LineWidth",2)
                       x_t_end = ceil(max(x)/1000)*1000;
                       ...
                       plot(app.background_corrected_raw_density, ...
                           x-x_back',y,"Color",'k',"LineWidth",2)
                       ylim(app.background_corrected_raw_density, ...
                           [1 max(y)]);

                       x_t_end = ceil(max(x-x_back')/500)*500;
                       if min(x-x_back') < 0
                           x_tick_rounder = -500;
                       else
                           x_tick_rounder = 500;
       ...
       function [y_bands, y_fit,r_squared] = FitGaussian(x,y,y_back, ...
                no_of_bands)
...
%                     text(0.99*xL(2),0.99*yL(2),str1,'HorizontalAlignment','right','VerticalAlignment','top')
        ...
        function [y_bands, y_fit,r_squared] = Fit3Gaussian(x,y,y_back, ...
                no_of_bands)
...
%             colormap(app.gel_image_axes,'gray')
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.RawOpticalDensityLabel_2.Position = [245 224 126 22];
            ...
            app.BackgroundCorrectedOpticalDensityLabel_2.Position = [486 221 126 28];
            ...
            app.GelImagePanel.Position = [278 8 408 370];
            ...
            app.gel_image_axes.Position = [10 13 387 330];
            ...
            app.GelImageFileInformationPanel.Position = [8 8 265 370];

            % Create ImFInfoArea
            app.ImFInfoArea = uitextarea(app.GelImageFileInformationPanel);
            app.ImFInfoArea.Editable = 'off';
            app.ImFInfoArea.FontSize = 11;
            app.ImFInfoArea.Position = [8 9 249 334];
