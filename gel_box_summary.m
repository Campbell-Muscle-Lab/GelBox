...
for i = 1 : length(im_handles)
    ...
    hold on
    h_n2b = patch(summary(i).band_1, ...
        summary(i).y,'b','FaceAlpha',0.1);
    h_n2ba = patch(summary(i).band_2, ...
    ...
    n2ba = (summary(i).top)/(summary(i).top+summary(i).bottom);
    n2b = (summary(i).bottom)/(summary(i).top+summary(i).bottom);
    
    str_n2b = sprintf('%%N2B = %.2f',n2b);
    str_n2ba = sprintf('%%N2BA = %.2f',n2ba);
    leg_labels = {str_n2ba,str_n2b};

    legendflex([h_n2ba,h_n2b], leg_labels, ...
        'xscale',0.15, ...
        'anchor',{'nw','nw'}, ...
        'buffer',[60 0], ...
        'padding',[1 1 2], ...
