            ...
            for fig_no = 1 : 2
                ...
                for i = 1 : length(summary)
                    rectangle('Position',box_positions(i,:),...
                        'EdgeColor','g',...
                        'LineWidth',2)
                    text(box_positions(i,1)+0.5*box_positions(i,3),box_positions(i,2)-50, ...
                        sprintf('%.0f',i),'FontWeight',"bold","FontSize",8,'HorizontalAlignment', 'center');
                end
