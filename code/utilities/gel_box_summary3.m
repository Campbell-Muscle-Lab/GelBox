...
left_pads = 0.75 * ones(1,no_of_panels_wide);
left_pads([1 2 3 5 6]) = 0.2;
...
for i = 1 : length(im_handles)
    ...
    bottom = fill(sp(back_fit_handles(i)),summary(i).x_back+summary(i).band_1, ...
        summary(i).y,'b','FaceAlpha',0.1);
    middle = fill(sp(back_fit_handles(i)),summary(i).x_back+summary(i).band_2, ...
        summary(i).y,'y','FaceAlpha',0.1);
    top = fill(sp(back_fit_handles(i)),summary(i).x_back+summary(i).band_3, ...
        summary(i).y,'r','FaceAlpha',0.1);
...
improve_axes('axis_handle',sp(fit_handles(i)),...
    ...
    'y_axis_label',{'Pixels'},'y_label_offset',-0.4,...
    'x_label_offset',-0.55,...
    'tick_font_size',9,...
    'label_font_size',9,...
